...
void WebApplicationCoreManager::createREADMEmd(){
    ...
    fileContent
        ...
        << "you own support.\n\n"
        << "## Created components\n\n"
        << "If you create a new component with tntwebwizard than you find in the base\n"
        << "directory of this new component a file with name \"initicomponent.h\".\n"
        << "For activating this new component you have to add a include in your main(.cpp)\n"
        << "file like:\n\n"
        << "> #include <[your component name]/initcomponent.h>\n\n"
        << "and put a function call after initiation of tntnet application class like:\n\n"
        << "> // Init Application Server\n"
        << "> tnt::Tntnet app;\n"
        << "> tnt::Configurator tntConfigurator( app );\n"
        ...
        << "> [your component namespace]::initcomponent( app );\n"
    ;
